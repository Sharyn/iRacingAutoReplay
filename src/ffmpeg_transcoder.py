...
if TYPE_CHECKING:
    ...
    from src.video_editing import VideoEdit  # For type hint
...
class FFmpegTranscoder:
    ...
    def transcode_video(
        ...
        if is_highlights:
            from src.video_editing import get_highlight_segments_to_keep, VideoEdit # Local import
...
if __name__ == '__main__':
    ...
    class MockOverlayData:
        def __init__(self, video_filename):
            from src.replay_data import CapturedVideoFile, RaceEvent # Local import for demo
    ...
    try:
        from src.video_editing import get_highlight_segments_to_keep # Test import
