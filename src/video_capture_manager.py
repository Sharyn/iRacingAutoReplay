...
from typing import List, Optional, TYPE_CHECKING # Added Any for AppStateManager initially
...
if TYPE_CHECKING:
    ...
    from src.app_state_manager import AppStateManager # For type hinting
