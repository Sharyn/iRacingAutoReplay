...
from PyQt6.QtCore import QTimer # Added QTimer for potential future use
...
class MainWindow(QMainWindow):
    ...
    def _update_live_telemetry(self):
        ...
        if self.iracing_manager.is_connected():
            ...
            self.ui_telemetry_status_label.setText(f"Disconnected. SDK Available: {IRSDK_AVAILABLE}")
