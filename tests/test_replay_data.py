...
from typing import Any  # Added List, Optional for completeness from replay_data
...
def test_parsing_helpers_robustness():
    ...
    from src.replay_data import _parse_optional_int, _parse_optional_float, _parse_bool
