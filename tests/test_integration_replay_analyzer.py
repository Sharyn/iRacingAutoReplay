...
from src.replay_data import OverlayData, LeaderBoardSnapshot
...
def test_analyzer_leaderboard_updates_driver_status(
    ...
    mock_sdk = pyirsdk_manager_fixture.ir_sdk
    from src.irsdk_manager import IRSDK_TRK_LOC_OFF_TRACK, IRSDK_TRK_LOC_IN_PIT_STALL
...
def test_analyzer_detects_off_track_incidents(
    ...
    from src.irsdk_manager import IRSDK_TRK_LOC_OFF_TRACK
...
def test_analyzer_detects_full_pit_stop_sequence(
    ...
    mock_app_settings.max_analysis_duration_seconds = 25
    from src.irsdk_manager import IRSDK_TRK_LOC_ON_PIT_ROAD, IRSDK_TRK_LOC_IN_PIT_STALL
...
def test_analyzer_detects_drive_through_as_pit_event(
    ...
    from src.irsdk_manager import IRSDK_TRK_LOC_ON_PIT_ROAD
    mock_sdk = pyirsdk_manager_fixture.ir_sdk
    driver_car_idx = 0
...
def test_analyzer_handles_analysis_end_while_car_in_pits(
    ...
    from src.irsdk_manager import IRSDK_TRK_LOC_IN_PIT_STALL
    mock_sdk = pyirsdk_manager_fixture.ir_sdk
    driver_car_idx = 0
    # ... (similar setup for driver info, initial states) ...
